# WatcomLibs
Some useful libraries converted to WatcomC++ 11.0 (+OpenWatcom,+DJGPP).
...
- APP_ZIP.CPP - a zip program that compresses the contents of a folder recursive and with long filenames.
...
- CORNERS.HPP - Haris/Noble corner detection.
...
**WatcomC also features 256MB with DOS4GW when used with SBEMUs HDPMI32i DPMI host, or maybe its JEMMEX.**
