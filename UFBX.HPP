// currently watcom complains of too large segment
...
//	#include <stdint.h> :mad:
#include "types.hpp" // :mad:
	#include <stddef.h>
//	#include <stdbool.h> :mad:
#endif

#define UINT64_C(__v__) ((uint64_t)(__v__)) // :mad:
#define UINT32_C(__v__) ((uint32_t)(__v__)) // :mad:
